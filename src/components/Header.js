    ...
    return (
        <>
            <header className='header' id='header'>
                ...
                <div className='border-b fixed w-full top-0 bg-white z-30'>
                    <div className="container-fluid">
                            ...
                            <div className="search-area flex items-center">
                                <div className="search-box w-full  border-2 rounded-full bg-[#f9f9f9] overflow-hidden flex items-center justify-between">
                                    <div className="input-box relative lg:w-full">
                                        <input type="text" name="" placeholder='Search the creative world at work' className='bg-transparent outline-none w-[90%] lg:w-full truncate pl-16 text-sm lg:text-l font-medium text-[#222] placeholder:text-[#777]' id="" />
                        ...
                        <div className="hidden lg:block">
                            <div className="behance-toools flex items-center justify-between pb-5 px-5   ">
                                ...
                                <botton className="recm-item">
                                   
                                    <bottom className="flex items-center ">
                                        <MdArrowDropDown />
                                       <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Recommended </label>
<select id="countries" class="bg-white text-black border border-black-300 text-sm rounded-lg focus:ring-white-500 focus:border-white-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500
">
  <option selected>Recommended</option>
  <option value="US">Curate</option>
  <option value="CA">Most Appreciated</option>
  <option value="FR">Most viewed</option>
  <option value="DE">Most Discussed</option>
